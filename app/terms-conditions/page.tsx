      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <Card className="mb-8 border-pink-100 shadow-lg">
            <CardHeader className="bg-gradient-to-r from-pink-50 to-pink-100">
              <CardTitle className="flex items-center text-2xl text-pink-800">
                <Scale className="h-6 w-6 mr-3 text-pink-600" />
                Acceptance of Terms
              </CardTitle>
            </CardHeader>
          ...
          <Card className="mb-8 border-pink-100 shadow-lg">
            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold text-pink-700 mb-3">Account Information</h4>
                ...
                <div>
                  <h4 className="font-semibold text-pink-700 mb-3">Prohibited Activities</h4>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-pink-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
          ...
          <Card className="mb-8 border-pink-100 shadow-lg">
            <CardHeader className="bg-gradient-to-r from-pink-50 to-pink-100">
              <CardTitle className="flex items-center text-2xl text-pink-800">
                <CreditCard className="h-6 w-6 mr-3 text-pink-600" />
                Payment Terms
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-pink-50 p-4 rounded-lg border border-pink-100">
                    <h4 className="font-semibold text-pink-700 mb-2">Subscription Plans</h4>
                  ...
                  <div className="bg-pink-50 p-4 rounded-lg border border-pink-100">
                    <h4 className="font-semibold text-pink-700 mb-2">Payment Processing</h4>
                    <ul className="space-y-1 text-sm text-gray-700">
          ...
          <Card className="mb-8 border-pink-100 shadow-lg">
            <CardHeader className="bg-gradient-to-r from-pink-50 to-pink-100">
              <CardTitle className="flex items-center text-2xl text-pink-800">
                <Shield className="h-6 w-6 mr-3 text-pink-600" />
                Privacy & Data Protection
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-pink-50 p-4 rounded-lg border border-pink-100">
                    <h4 className="font-semibold text-pink-700 mb-2">Data Collection</h4>
                  ...
                  <div className="bg-pink-50 p-4 rounded-lg border border-pink-100">
                    <h4 className="font-semibold text-pink-700 mb-2">Data Security</h4>
          ...
          <Card className="mb-8 border-pink-100 shadow-lg">
            <CardHeader className="bg-gradient-to-r from-pink-50 to-pink-100">
              <CardTitle className="flex items-center text-2xl text-pink-800">
                <AlertTriangle className="h-6 w-6 mr-3 text-pink-600" />
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <div className="bg-pink-50 border border-pink-200 p-4 rounded-lg">
                  <h4 className="font-semibold text-pink-700 mb-2">Service Availability</h4>
                  <p className="text-pink-800 text-sm">
                    We strive to maintain 99.9% uptime but cannot guarantee uninterrupted service availability.
                  </p>
                </div>
                <div className="space-y-3">
                  <h4 className="font-semibold text-pink-700">Important Disclaimers:</h4>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-pink-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
          ...
          <Card className="mb-8 border-pink-100 shadow-lg">
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-pink-700 mb-3">User Termination</h4>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <div className="w-2 h-2 bg-pink-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  ...
                  <div>
                    <h4 className="font-semibold text-pink-700 mb-3">Platform Termination</h4>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <div className="w-2 h-2 bg-pink-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
            ...
            <CardContent className="p-6">
              <div className="text-center space-y-4">
                ...
                <div className="space-y-2">
                  <p className="text-pink-600 font-medium">legal@humsafar.com</p>
                  <p className="text-pink-600 font-medium">+92 (21) 1234-5678</p>
                </div>
