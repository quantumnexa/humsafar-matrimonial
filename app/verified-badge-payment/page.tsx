...
export default function VerifiedBadgePaymentPage() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      // Add verified badge to user subscription
      const success = await UserSubscriptionService.addAddon('verified_badge')
              ...
              <div className="space-y-6">
                <Card className="border-humsafar-200">
                  ...
                  <CardContent className="text-center">
                    ...
                    <div className="mb-6">
                      <Badge className="bg-blue-600 text-white text-lg px-4 py-2 mb-3">
                        ✅ Verified Badge
                      </Badge>
